...
class Ward(db.Model):
    ...
    ward_link = db.relationship('UserModel', backref='ward_link')
...
class Patient(db.Model):
    ...
    #patients = db.relationship('UserModel', backref='patients')
    assigned_ward = db.Column(db.Integer, db.ForeignKey('Ward.ward_id'))
    assigned_consultant = db.Column(db.Integer, db.ForeignKey('UserModel.id'))

# class Users(db.Model):
#     sus = db.Column(db.String)
